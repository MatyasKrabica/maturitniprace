...
<body class="bg-gray-100 dark:bg-[#0a0a0c] text-gray-900 dark:text-gray-200 min-h-screen py-12 px-4 transition-colors duration-300">
    ...
    <div class="max-w-2xl mx-auto">
        <div class="text-center mb-10">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Vytvořit účet</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-3">Staňte se součástí naší komunity a začněte plnit výzvy.</p>
        </div>
        ...
        <div class="bg-white dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-gray-200 dark:border-white/10 shadow-2xl overflow-hidden">
            ...
            <form method="POST" id="registerForm" autocomplete="off" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Uživatelské jméno</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Emailová adresa</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 dark:border-white/5 pt-6">
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Heslo</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Potvrzení hesla</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-100 dark:border-white/5 pt-6">
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Jméno</label>
                        <input name="first_name" required value="<?= htmlspecialchars($old['first_name']) ?>"
                               class="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 focus:border-blue-500 outline-none transition-all"
                               placeholder="Jméno">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Příjmení</label>
                ...
                <div class="space-y-4 border-t border-gray-100 dark:border-white/5 pt-6">
                    <h3 class="text-xs font-bold uppercase tracking-widest text-blue-500 mb-2">Působiště</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-gray-400 mb-1">Země</label>
                        ...
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-gray-400 mb-1">Kraj</label>
                        ...
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-gray-400 mb-1">Město</label>
            ...
            <div class="bg-gray-50 dark:bg-white/[0.02] p-6 text-center border-t border-gray-100 dark:border-white/5">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="login.php" class="text-blue-500 hover:text-blue-600 font-bold ml-1 transition-colors">Přihlaste se</a>
                </p>
            </div>
        </div>
    </div>
