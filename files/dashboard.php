                ...
                <div class="lg:col-span-4 space-y-6">
                    ...
                    <div class="glass rounded-3xl p-7 space-y-5 text-sm shadow-sm dark:shadow-none">
                        ...
                        <div class="flex justify-between items-center border-b border-gray-100 dark:border-white/5 pb-4">
                            ...
                            <span class="text-gray-800 dark:text-white font-medium"><?= htmlspecialchars($user['city_name'] ?? t('unknown','Neznámé')) ?></span>
                        </div>
                                                <div class="flex justify-between items-center border-b border-gray-100 dark:border-white/5 pb-4">
                            ...
                            <span class="text-gray-800 dark:text-white font-medium"><?= htmlspecialchars($user['region_name'] ?? t('unknown','Neznámé')) ?></span>
                        </div>
