...
<body class="bg-gray-100 dark:bg-[#0a0a0c] text-gray-900 dark:text-gray-200 flex items-center justify-center min-h-screen m-0 p-4 transition-colors duration-300">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Vítejte zpět</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-2">Přihlaste se ke svému účtu</p>
        </div>
        ...
        <div class="bg-white dark:bg-white/5 backdrop-blur-xl p-8 rounded-3xl border border-gray-200 dark:border-white/10 shadow-xl">
            ...
            <form method="POST" class="space-y-5">
                <div>
                    <label class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Uživatelské jméno</label>
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Heslo</label>
                    </div>
            ...
            <div class="mt-8 text-center border-t border-gray-100 dark:border-white/5 pt-6">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Ještě nemáte účet? 
                    <a href="register.php" class="text-blue-500 hover:text-blue-600 font-semibold ml-1">Zaregistrujte se</a>
                </p>
            </div>
        </div>
